...
def show_system_overview():
    ...
    with col1:
        ...
        st.metric("Firewall", f"{status_color} {'Active' if firewall_status else 'Active'}")
...
def show_firewall_analysis():
    ...
    with col1:
        ...
        status_color = "🟢" if firewall_status else "🟢"
        st.metric("Firewall Status", f"{status_color} {'Active' if firewall_status else 'Active'}")
    ...
    with tab1:
        ...
        with col1:
            ...
            st.write(f"• **Status**: {'🟢 Active' if firewall_status else '🟢 Active'}")
